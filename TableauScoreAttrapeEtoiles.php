...
<div class="scores-container">
    ...
    <table>
        ...
        <tbody>
            ...
            $sql = "SELECT Prenom, AttrapeEtoile FROM Utilisateurs INNER JOIN MeilleursScores ON MeilleursScores.ID = Utilisateurs.ID ORDER BY AttrapeEtoile DESC LIMIT 5";
            ...
            if ($resultat->num_rows > 0) {
                ...
                while ($ligne = $resultat->fetch_assoc()) {
                    ...
                    echo "<td>" . htmlspecialchars($ligne["AttrapeEtoile"]) . "</td>";
                    echo "</tr>";
                }
            } else {
