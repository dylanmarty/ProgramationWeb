...
<div class="scores-container">
    ...
    <table>
        ...
        <tbody>
            ...
            $sql = "SELECT Prenom, Snake FROM Utilisateurs INNER JOIN MeilleursScores ON MeilleursScores.ID = Utilisateurs.ID ORDER BY Snake DESC LIMIT 5";
            ...
            if ($resultat->num_rows > 0) {
                ...
                while ($ligne = $resultat->fetch_assoc()) {
                    ...
                    echo "<td>" . htmlspecialchars($ligne["Snake"]) . "</td>";
                    echo "</tr>";
                }
            } else {
